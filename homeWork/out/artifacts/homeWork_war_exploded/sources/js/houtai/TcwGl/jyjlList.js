...
function LoadingResources() {
    ...
    $("#jyjl_content").bootstrapTable({
        url: CTX + '/yhPark/queryAllJyDataByPage.html',
        ...
        columns:[
            ...
            {title:"车牌号",field:"clSkey",align:"left",order:"desc"},
            {title:"车位",field:"paSkey",align:"left",order:"desc"},
            {title:"开始时间",field:"tcKssj",align:"left",order:"desc"},
            {title:"结束时间",field:"tcJssj",align:"left",order:"desc"},
            {title:"停车状态",field:"tcZt",align:"left",order:"desc"},
            {title:"收费",field:"paSf",align:"left",order:"desc"},
