...
function loadPage() {
    ...
    $("#ZxYh_Content").bootstrapTable({
        url: CTX + '/redisOnlineUser/getUserList.html',
        ...
        columns:[
            ...
            {title:"用户单位",field:"unit",align:"left",order:"desc"},
 ...
 */
function refZxYh() {
    $("#ZxYh_Content").bootstrapTable('refresh',{url:CTX+"/redisOnlineUser/getUserList.html?type = 1 "})
