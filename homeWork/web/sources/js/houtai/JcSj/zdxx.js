...
function LoadingResources() {
    ...
    $("#xt_ZdContent").bootstrapTable({
        url: CTX + '/xtyhzb/getXtZdPageList.html',
        ...
        columns:[
            ...
            {title:"用户",field:"yhskey",align:"left",order:"desc"},
            {title:"消费金额",field:"xfje",align:"left",formatter:function (value) {
                return value+"元";
            },order:"desc"},
            {title:"消费时间",field:"xfsj",align:"left",order:"desc"},
            {title:"消费地点",field:"xfdd",align:"left",order:"desc"}
...
function searZdxx() {
    var index = layer.open({
        title:['查找账单信息','background-color : #26A69A ; color : #fff; font-size : 14 px; font-weight : 700; text-align : center'],
        area:['36%','48%'],
 ...
 */
function refZdxx() {
    $("#xt_ZdContent").bootstrapTable('refresh',{url:CTX+"/xtyhzb/getXtZdPageList.html"})
}
